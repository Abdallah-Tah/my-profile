    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-xl">
            <p className="text-gray-700 leading-relaxed text-lg">
              I'm a full-stack developer with over 8 years of experience building
              web applications for both small and large businesses. I've worked
              primarily with PHP, Laravel, and Python, along with several other
              languages, and have built numerous personal projects as well. I'm
              excited to join a team that values simplicity and clean
              architecture. I enjoy working on new projects as well as modernizing
              legacy systems. I have strong experience with APIs, security,
              automation, and team collaboration — especially in remote
              environments. I consistently strive to write clean, testable code
              and build software that solves real-world problems.
            </p>
          </div>
        </div>bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
              <h3 className="text-xl font-bold text-blue-800 mb-3">Djib-Payroll</h3>
              <p className="text-gray-700 mb-4">A custom AI-powered payroll management system designed for businesses in Djibouti, automating payroll processing and HR tasks.</p>
              <a href="https://www.djib-payroll.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
                Visit Website →
              </a>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
              <h3 className="text-xl font-bold text-green-800 mb-3">SmartyReport</h3>
              <p className="text-gray-700 mb-4">A Shopify application for data analytics and reporting, helping e-commerce businesses make data-driven decisions.</p>
              <span className="text-green-600 font-medium">Shopify App Store</span>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
              <h3 className="text-xl font-bold text-purple-800 mb-3">Intellink</h3>
              <p className="text-gray-700 mb-4">A community platform for healthcare policy professionals to connect, share insights, and access premium resources.</p>
              <a href="https://www.intellink.pro/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-purple-600 hover:text-purple-800 font-medium">
                Visit Website →
              </a>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200">
              <h3 className="text-xl font-bold text-orange-800 mb-3">V-Carte</h3>
              <p className="text-gray-700 mb-4">A digital business card solution for Djibouti users, providing access to international digital services and products.</p>
              <a href="https://www.v-carte.pro/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-orange-600 hover:text-orange-800 font-medium">
                Visit Website →
              </a>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 rounded-2xl shadow-xl p-8 text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-6">Let's discuss how I can help bring your next project to life.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              ...
              onClick={() => window.open('mailto:abdallahtmohamed86@gmail.com', '_blank')}
            >
              Contact Me
            </Button>
          </div>
